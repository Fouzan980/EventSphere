  ...
  return new Promise((resolve, reject) => {
    ...
    function generate(html2pdf) {
      ...
      const runHtml2Pdf = () => {
          ...
          ">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; border-bottom: 2px dashed #e2e8f0; padding-bottom: 18px; margin-top: 12px;">
              <div style="display: flex; align-items: center; gap: 8px;">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="vertical-align: middle;">
        ...
        // Delay execution to allow DOM painting
        setTimeout(() => {
